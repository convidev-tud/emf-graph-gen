...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Delete Edge</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link graphdelta.impl.DeleteEdgeImpl#getNodeA <em>Node A</em>}</li>
 *   <li>{@link graphdelta.impl.DeleteEdgeImpl#getNodeB <em>Node B</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DeleteEdgeImpl extends DeltaOperationImpl implements DeleteEdge {
	/**
	...
	protected EClass eStaticClass() {
		return GraphdeltaPackage.Literals.DELETE_EDGE;
	}
	...
	public void setNodeA(String newNodeA) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphdeltaPackage.DELETE_EDGE__NODE_A, oldNodeA,
					nodeA));
	}
	...
	public void setNodeB(String newNodeB) {
		...
		nodeB = newNodeB;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphdeltaPackage.DELETE_EDGE__NODE_B, oldNodeB,
					nodeB));
	}
